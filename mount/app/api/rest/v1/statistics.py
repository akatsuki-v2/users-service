...
@router.get("/v1/accounts/{account_id}/statistics/{game_mode}", response_model=Statistics)
...
@router.get("/v1/accounts/{account_id}/statistics", response_model=list[Statistics])
...
@router.patch("/v1/accounts/{account_id}/statistics/{game_mode}", response_model=Statistics)
